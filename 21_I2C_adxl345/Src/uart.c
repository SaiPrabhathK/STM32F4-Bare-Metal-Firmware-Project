...
void dma1_stream6_ch4_init(uint32_t src, uint32_t dst, uint32_t len)
{
...
void uart2_rxtx_init(void)
{
	...
	/* Set PA2 alternate function type to UART_TX (AF07), AFRL is for pins 0 to 7, AFRL is AFR[0] */
	GPIOA->AFR[0] |= (1U<<8);
	GPIOA->AFR[0] |= (1U<<9);
	GPIOA->AFR[0] |= (1U<<10);
	GPIOA->AFR[0] &= ~(1U<<11);
